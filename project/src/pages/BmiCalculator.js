...
// ✅ Crash detectors (very useful on Railway)
...
// ⚠️ This stores password exactly as received (NOT hashed)
// If you want hashed registration, tell me and I’ll update it safely.
...
app.post("/login", (req, res) => {
  ...
  db.query(sql, [email.trim()], async (err, data) => {
    try {
      ...
      console.error("🔥 LOGIN CALLBACK CRASH:", e);
      return res.status(500).json({
